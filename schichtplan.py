...
employees = [
    f"Mitarbeiter {i}" for i in range(1, 12)
]
...
def optimize_schedule():
    ...
    # 6. Minimierung der Überstunden
    model.Minimize(sum(overtime[employee] for employee in employees))

    # 7. Minimierung der Differenz zwischen den Arbeitszeiten der Mitarbeiter (für eine gleichmäßigere Verteilung)
